  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <aside className={`fixed top-0 left-0 z-50 h-full w-64 bg-white border-r border-slate-200 transform transition-transform duration-300 lg:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center gap-3 px-6 py-5 border-b border-slate-200">
            ...
            <div>
              <h1 className="font-bold text-slate-900">Portal Siswa</h1>
              <p className="text-xs text-slate-500">PKBM An-Najah</p>
            </div>
            <button 
              onClick={() => setSidebarOpen(false)}
          ...
          <div className="p-4 border-t border-slate-200">
            ...
            <button
              ...
              className="flex items-center gap-3 w-full px-4 py-3 text-slate-500 hover:text-red-400 hover:bg-red-500/10 rounded-xl transition-all"
            >
      ...
      <div className="lg:pl-64">
        {/* Top bar for mobile */}
        <header className="sticky top-0 z-30 bg-slate-50/95 backdrop-blur border-b border-slate-300 lg:hidden">
          <div className="flex items-center gap-4 px-4 py-3">
            ...
            <span className="font-semibold text-slate-900">Portal Siswa</span>
          </div>
        </header>
