        ...
        <div className="max-w-6xl mx-auto px-4 pt-20 pb-24 relative">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                href="/register"
                className="inline-flex items-center gap-2 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white px-8 py-4 rounded-xl font-semibold shadow-lg shadow-emerald-500/30 transition-all duration-200 text-lg"
              >
                Daftar Sekarang
              ...
              <Link
                href="/login"
                className="inline-flex items-center gap-2 bg-white/5 hover:bg-white/10 border border-white/10 text-white px-8 py-4 rounded-xl font-semibold transition-all duration-200 text-lg"
              >
                Masuk
              </Link>
            </div>
          ...
          <div className="grid grid-cols-3 gap-4 mt-16 max-w-xl mx-auto">
            <div className="text-center">
              ...
              <div className="text-sm text-slate-400 mt-1">Program</div>
            </div>
            <div className="text-center border-x border-slate-700">
              <div className="text-2xl sm:text-3xl font-bold text-emerald-400">33</div>
              <div className="text-sm text-slate-400 mt-1">Mata Pelajaran</div>
            </div>
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-bold text-emerald-400">24/7</div>
              <div className="text-sm text-slate-400 mt-1">Akses Belajar</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {programs.map((program) => (
              <div
                key={program.slug}
                className={`bg-slate-800/50 border ${program.borderColor} rounded-2xl p-6 ${program.hoverBorder} transition-all duration-300 group hover:shadow-lg`}
              >
                ...
                <Link
                  href="/register"
                  className={`block text-center py-3 rounded-xl font-semibold bg-gradient-to-r ${program.bgGradient} text-white hover:opacity-90 transition-opacity`}
                >
                  Daftar {program.name}
                </Link>
              </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-slate-800 border border-slate-700 rounded-2xl p-6 hover:border-emerald-500/50 transition-all">
              ...
              <h3 className="text-lg font-bold text-white mb-2">Materi Digital</h3>
            ...
            <div className="bg-slate-800 border border-slate-700 rounded-2xl p-6 hover:border-emerald-500/50 transition-all">
              ...
              <h3 className="text-lg font-bold text-white mb-2">Latihan Soal</h3>
              <p className="text-slate-400">
            ...
            <div className="bg-slate-800 border border-slate-700 rounded-2xl p-6 hover:border-emerald-500/50 transition-all">
              ...
              <h3 className="text-lg font-bold text-white mb-2">Pantau Progress</h3>
              <p className="text-slate-400">
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {legality.map((item, index) => (
              <div key={index} className="bg-slate-800/50 border border-slate-700 rounded-2xl p-6 text-center hover:border-emerald-500/30 transition-all">
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {benefits.map((benefit, index) => (
              <div key={index} className="bg-slate-800 border border-slate-700 rounded-2xl p-6 hover:border-emerald-500/30 transition-all group">
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4">
          <div className="bg-gradient-to-br from-emerald-900/40 to-teal-900/40 border border-emerald-500/20 rounded-3xl p-8 sm:p-12 text-center">
            ...
            <Link
              href="/register"
              className="inline-flex items-center gap-2 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white px-8 py-4 rounded-xl font-semibold shadow-lg shadow-emerald-500/30 transition-all duration-200 text-lg mb-10"
            >
              Daftar Sekarang
              <ChevronRight className="w-5 h-5" />
            </Link>
            ...
            <div className="border-t border-emerald-500/20 pt-8 mt-4">
              <p className="text-slate-400 mb-4 text-sm uppercase tracking-widest font-medium">Hubungi Kami</p>
